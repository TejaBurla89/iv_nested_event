...
\node[annotation,color=amber,anchor=north]
  at (0.30,1.56) {Declared continuation};
\node[keylabel,color=amber,anchor=north west] at (1.58,1.82)
  {Predicted no-event LATE};
